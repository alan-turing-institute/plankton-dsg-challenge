...
The resulting plot nicely illustrates the variability in class size and class divesity of label3 images.

I commented out the table saving command here. Please enable if you want to regenerate the images.
